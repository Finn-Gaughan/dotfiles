...
alias th="task priority:H list project: limit:page" # "th" is short for "Task High priority"
alias tm="task priority:M list project: limit:page" # "th" is short for "Task High priority"
alias h="harsh"
alias p3="python3"
...
mark() {
  ...
  local file="$HOME/marks.md"
  
  # Get the current date and time
  local timestamp=$(date "+%Y-%m-%d %H:%M:%S")
  
  # Append the timestamp and the arguments passed to the command
  echo "$timestamp $*" >> "$file"
}
